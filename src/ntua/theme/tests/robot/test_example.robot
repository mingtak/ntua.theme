...
#
#  $ bin/test -s ntua.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ntua.theme.testing.NTUA_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ntua/theme/tests/robot/test_example.robot
#
